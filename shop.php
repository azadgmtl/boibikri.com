...
<body>
    ...
    <!-- Products banner Section started from here -->
    ...
    <!-- Products banner Section ended here -->



    <!-- Products Details Section started from here -->
    ...
    <!-- Products Details Section ended here -->
